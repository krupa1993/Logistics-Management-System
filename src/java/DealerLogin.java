 ...
 * @author ronakrana
 */
@WebServlet(urlPatterns = {"/DealerLogin"})
public class DealerLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        try
        {
            System.out.println("in dealerlogin servlet");
            ...
            rs=stmt.executeQuery("select UserName,Password from dealer_registration where UserName='"+user+"' and Password='"+password+"'");
