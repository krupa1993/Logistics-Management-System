<%-- 
    ...
    Created on : Apr 9, 2015, 3:19:46 PM
    Author     : ronakrana
--%>
...
<body>
    <form name="VendorForm" method="get" action="VendorRegistrationServlet">
    <%
        String name="";
        String usernm="";
        String pwd="";
	...
	<div id="contentsMaster">
        ...
        <tr>
            <td>
                 ...
                 <label id="Label9"  class="lblFormHeader" >Vendor Registration Form</label> 
            </td>
        </tr>
        <tr>
            ...
            <table cellpadding="5px" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <label id="lbl1"  class="lblForm" >Name:</label> 
                    ...
                    <tr>
                        <td>
                            <label id="Label1"   class="lblForm" >User Name:</label> 
                        </td>
                        <td>
                            
                           <input id="txtUserName" name="usernm" type="text" class="inputFrm" value="<%=usernm%>" onblur="duplicateUsername();" required/>
                         </td>
                         <td>
                    ...
                    <tr>
                        <td>
                            <label id="Label2"  class="lblForm" >Password:</label> 
                        </td>
                    ...
                    <tr>
                        ...
                        <tr>
                        <td>
                            <label id="Label8"   class="lblForm" >Phone Number:</label> 
                        </td>
                        <td>
                         ...
                         <tr>
                        <td>
                            <label id="Label9"   class="lblForm" >Mobile Number:</label> 
                        </td>
                        <td>
                         ...
                         <tr>
                        <td>
                            <label id="Label20"   class="lblForm" >Fax:</label> 
                        </td>
                        <td>
                        ...
                        <tr>
                        <td>
                            <label id="Labe21"   class="lblForm" >Contact Person:</label> 
                        </td>
                        <td>
                         ...
                         <tr>
                        <td>
                            <label id="Label22"   class="lblForm" >Contact Person Number:</label> 
                        </td>
                        <td>
                            
                            <input id="txtContPersonNo" type="text" name="contactperson_no" class="inputFrm" value="<%=contactperson_no%>" required maxlength="10"/>
                            
                        </td>
                        </tr>
                         <tr>
                        <td>
                            <label id="Label23"   class="lblForm" >Email ID:</label> 
                        </td>
                        <td>
                         ...
                         <tr>
                        <td>
                            <label id="Label24"   class="lblForm" >Website:</label> 
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <label id="Label25"   class="lblForm" >Description:</label> 
                        </td>
                        <td>
